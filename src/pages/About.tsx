...
const About = () => {
  ...
  return (
    <div className="bg-[#202C36] h-screen sm:h-[615px] flex flex-col sm:flex-row items-center justify-center gap-4">
      <Link
        to="/"
        className="w-[104px] h-8 bg-[#2B3844] self-start ml-5 text-center rounded-md"
      >
        back
      </Link>
      <img src={`${data[0].flags?.png}`} alt="" className="sm:w-[560px]" />
      <div className="ml-4">
        <div className="flex-row flex items-center justify-start">
          <p
            className="text-white text-3xl font-extrabold leading-normal
